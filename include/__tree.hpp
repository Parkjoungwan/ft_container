...
namespace ft
{
	//red-black tree 구현, 관련 함수 src/tree.cpp에 구현
	...
	//_Key: key of node
	//_Val: value of node
	//_KeyofValue: get key of value functor
	//_Compare: Comparing functor, in here <(std::less)
	//_Alloc: allocator
	...
	class __tree
	{
		...
		private:
			...
			//helpers for public member function
	...
	//copy tree
	//__x: root of new tree
	//__p: first, end() and than parent of __x
	
	template <typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
			 typename _Alloc>
	typename __tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_Link_type
	__tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::__copy_tree(_Link_type __x, _Base_ptr __p)
	{
	...
	//_erase_helper: rebalance for red-black tree
	template <typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
			 typename _Alloc>
	...
	//__lower_bound_helper: key보다 크거나 같은 iterator 반환
	//__x: 시작 노드
	//__y: result 노드
	//__k: 비교 key
	template <typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
	...
	//__upper_bound_helper: key 보다 큰 iterator 반환
	//__x: 시작 노드
	//__y: result 노드
	//__k: 비교용 key
	template <typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
	...
	//equal_range: 가져온 container안에 key값을 포함하는 upper, lower bound 반환
	template <typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
			 typename _Alloc>
	ft::pair<typename __tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator,
		typename __tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::iterator>
